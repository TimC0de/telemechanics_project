...
# Form implementation generated from reading ui file 'ui\modbus_rtu_registers.ui'
#
...
"}")
        ...
        self.pushButton_8.setStyleSheet("QPushButton { border: none; border-top-left-radius: 5px; border-top-right-radius: 5px; background-color: transparent; }")
    ...
    def settingsRender(self):
        ...
        self.frame.setGeometry(QtCore.QRect(0, 60, 245, 70))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.secondOption = QtWidgets.QRadioButton(self.frame)
        self.secondOption.setGeometry(QtCore.QRect(145, 40, 95, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.secondOption.setFont(font)
        self.secondOption.setObjectName("secondOption")
        self.firstOption = QtWidgets.QRadioButton(self.frame)
        self.firstOption.setGeometry(QtCore.QRect(0, 40, 95, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.firstOption.setFont(font)
        self.firstOption.setObjectName("firstOption")
        self.label = QtWidgets.QLabel(self.frame)
        self.label.setGeometry(QtCore.QRect(0, 0, 245, 40))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.frame_16 = QtWidgets.QFrame(self.frame_9)
        self.frame_16.setGeometry(QtCore.QRect(0, 135, 245, 70))
...
"QHeaderView::section { border: 1px solid #aaa; }")
        ...
        # self.frame_3.setGeometry(QtCore.QRect(700, 310, 155, 181))
        ...
        self.secondOption.setText(_translate("Form", "4-3-2-1"))
        self.firstOption.setText(_translate("Form", "2-1-4-3"))
        ...
        self.firstOption.setChecked(self.device.settings.get("registers_ordinalByte_1") or False)
        self.firstOption.toggled.connect(lambda: self.updateDeviceState("firstOption", "registers_ordinalByte_1"))
        self.secondOption.setChecked(self.device.settings.get("registers_ordinalByte_2") or False)
        self.secondOption.toggled.connect(lambda: self.updateDeviceState("secondOption", "registers_ordinalByte_2"))
    ...
    def updateDeviceState(self, buttonName, propertyName):
        self.device.settings[propertyName] = getattr(self, buttonName).isChecked()
